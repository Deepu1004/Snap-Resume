    ...
    <div className="min-h-screen bg-gradient-to-br from-indigo-50 via-white to-purple-50 relative overflow-hidden">
      ...
      <div className="relative py-8 px-4 mt-20 max-w-7xl mx-auto">
        ...
        <div className="flex flex-col lg:flex-row gap-8">
          ...
          >
            <motion.div
              className="bg-white/80 backdrop-blur-xl rounded-3xl shadow-xl border border-white/20 overflow-hidden sticky top-24 transition-transform duration-300"
            >
                  ...
                  <motion.button
                    ...
                    className={`w-full flex items-center space-x-3 px-4 py-3 rounded-xl transition-all duration-300 ${
                      activeSection === section.id
                        ...
                        : "text-gray-600 hover:bg-gradient-to-r from-indigo-50 to-purple-50"
                    }`}
          ...
          >
            <motion.div
              className="bg-white/80 backdrop-blur-xl rounded-3xl shadow-xl border border-white/20 transition-transform duration-300"
